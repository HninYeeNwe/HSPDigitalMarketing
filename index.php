			...
			<ul class="navbar-nav nav-pills">
		      ...
		      <!-- <li class="nav-item pr-4 mb-2">
				...
				<li class="nav-item pr-4 mb-2 dropdown">
					<a class="nav-link dropdown-toggle" href="#client" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-friends mr-2"></i>သုံးစွဲသူများ</a>
			...
			<div class="container py-5">
				...
				<div class="row mt-3 ">
					<div class="col-lg-8">
						...
						<p class="font-rb">ကျွန်မတို့၏ ဆန်းသစ်သော Ideaများ၊ Digital Marketing နှင့် ပတ်သက်၍ ရရှိထားသော အတွေ့အကြုံများဖြင့် လူကြီးမင်းတို့၏ Product တွေ၊ Brand တွေကို Customerများ ဝယ်ယူအသုံး ပြုလာရန် ဖန်တီးပေးပြီး ပုံမှန် Facebook Follower များမှတစ်ဆင့် လူကြီးမင်းတို့၏ Product များကို အမှန်တစ်ကယ်သုံးစွဲသော Customer များဖြစ်လာစေရန် ကူညီဆောင်ရွက်ပေးနေပါသည်။..<a href="aboutus.php">See more</a></p>
					</div>
					<div class="col-lg-4">
...
<!-- our service section start-->
	<section id="service" class="px-3 py-3">
		<div class="container">
			<h4 class="text-red text-center mt-3">ဝန်ဆောင်မှုများ</h4>
			<div class="row mt-3">
...
<!-- blog section start -->
	<section id="blogvd">
		<div class="container-fluid py-5">
			<div class="row">
				<div class="col-md-6">
					<h5 class="my-5 ml-4">သင့်လုပ်ငန်းတွေအောင်မြင်ဖို့ HSP နဲ့ချိတ်ဆက်စို့....
		...
		<div class="container-fluid mb-2">
			<div class="row">
				...
				<div class="col-lg-4 mt-3 my-2">
					...
					<p class="font-rb font-size-16 ml-4">
						<!-- <a href="hsp.marketingagency@gmail.com" class="text-dark"> -->
							<a href="mailto:hsp.marketingagency@gmail.com" class="text-dark">
					...
					<p class="font-rb font-size-16 ml-4"><i class="fas fa-home mr-2"></i>No. 157,Bogyoke Road,Ywar Bae` East Ward,Near CB Bank (2), Pyay,Bago Region,Myanmar,18156</p>
				</div>
				<div class="col-lg-4 mt-3 my-2">
